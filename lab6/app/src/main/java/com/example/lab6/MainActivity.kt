...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //建立要顯示在的列表上的字串
        val item = arrayOf("全麥吐司", "小麥吐司", "鮮奶吐司", "紅豆吐司", "抹茶吐司")
        //Button 點擊事件
        btn_toast.setOnClickListener {
            showToast("白Toast") //執行 showToast 方法
        }
        btn_custom.setOnClickListener {
            ...
            toast.view =
                layoutInflater.inflate(R.layout.toast, null)
            //顯示於螢幕
            toast.show()
        }
        ...
        btn_dialog1.setOnClickListener {
            ...
            AlertDialog.Builder(this)
                ...
                .setNeutralButton("左轉") { dialog, which ->
                    showToast("左轉")
                }
                .setNegativeButton("直走") { dialog, which ->
                    showToast("直走")
                }
                .setPositiveButton("右轉") { dialog, which ->
                    showToast("右轉")
                }.show()
        }
